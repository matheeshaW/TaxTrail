      ...
      <div className="tt-root">
        <div className="tt-card">
          ...
          <section className="tt-left">
            <div className="tt-brand">
              ...
              <p className="tt-brand-desc">
                Public finance insights for Sri Lanka's governance teams — tax, budget, and regional analysis unified.
              </p>
            </div>
            ...
            <div className="tt-features">
              <div className="tt-feature">
                ...
                <div className="tt-feature-text">Track tax contributions by region and year</div>
              </div>
              <div className="tt-feature">
                <div className="tt-feature-dot" />
                <div className="tt-feature-text">Switch between records and analytical summaries instantly</div>
              </div>
              <div className="tt-feature">
                <div className="tt-feature-dot" />
                <div className="tt-feature-text">Built for transparency and policy decision support</div>
              </div>
            </div>
          ...
          <section className="tt-right">
            <div className="tt-eyebrow">Secure Portal</div>
            <h1 className="tt-heading">Welcome back</h1>
            <p className="tt-subheading">Sign in to continue to your dashboard.</p>
            ...
            <div className="tt-footer">
              Don&apos;t have access?{" "}
              <Link to="/register" className="tt-link">
                Request an account →
              </Link>
            </div>
          </section>
